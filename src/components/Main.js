    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>I am also a huge advocate and practitioner of personal growth and productivity. I strive to be the best version of myself. Always looking for ways to improve myself and the efficiency of my routines translates well into my work with software quality assurance, testing and automation. </p>
          {close}
        </article>
