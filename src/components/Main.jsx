    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>If I could freeze time, I would consume all the information in the world. Out of my many interests, my true passions are software development, automation and music production. I am always working on a project, automating a task or getting a melody out of my head and into my DAW (Digital Audio Workstation, i.e. music production software). If I'm not currently working on something, I always have an endless stream of ideas still flowing in my head. Creative problem solving is something I feel comes naturally to me. </p><p>I am also a huge advocate and practitioner of personal growth and productivity. I strive to be the best version of myself. Always looking for ways to improve myself and the efficiency of my routines translates well into my work with software quality assurance, testing and automation. </p>
          {close}
        </article>
